...
def read_raw_dataset(review_path, meta_path, savepath, pp):
...
def records_writer(
    ...
    uid_hist_iid_seq, uid_hist_iid_freq_seq, uid_hist_cid_seq, uid_hist_cid_freq_seq, \
    ...
    def _build_example(
        uid, iid, iid_freq, neg_iid_list, cid, cid_freq, neg_cid_list, bid, bid_freq, timestamp,
