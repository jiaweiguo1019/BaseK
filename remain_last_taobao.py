from basek.preprocessors.remain_last_taobao import read_reviews, records_writer
...
if __name__ == '__main__':
    ...
    dirpath = '/data/project/datasets/Taobao'

    for drop_dups in (False,):
        for pp in (5, 10, 20, 30, 50):
