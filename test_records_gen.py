...
if __name__ == '__main__':
    ...
    test_writer(
        '/data/project/tfrecords/seq_len_50-test_drop_hist-k_core_20-id_ordered_by_count-test.tfrecords',
        '/home/web_server/guojiawei/basek/datasets/Taobao/k_core_20-id_ordered_by_count-train_dataset_df.pkl',
        '/home/web_server/guojiawei/basek/datasets/Taobao/k_core_20-id_ordered_by_count-test_dataset_df.pkl',
        '/home/web_server/guojiawei/basek/datasets/Taobao/k_core_20-id_ordered_by_count-sparse_features_max_idx.pkl',
        '/home/web_server/guojiawei/basek/datasets/Taobao/k_core_20-id_ordered_by_count-iid_to_cid.pkl',
        split_ts,
        50,
        True,
        None
                ...
                for test_drop_hist in (True, False):
                    ...
                    p = Process(
                        ...
                        kwargs={
                            ...
                            'test_dataset_df_path': os.path.join(dataset_prefix, train_dataset_df_path),
