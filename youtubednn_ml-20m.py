...
from basek.preprocessors.ml_20m_preprocessor import read_reviews, DataLoader
...
if __name__ == '__main__':
    ...
    meta_path = './datasets/MovieLens/ml-20m/movies.csv'
    review_path = './datasets/MovieLens/ml-20m/ratings.csv'
